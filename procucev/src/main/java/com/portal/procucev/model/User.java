...
public class User implements Serializable {
	...
	@Column(name="is_password_firsttime")
	private String isPasswordFirsttime;

	@Column(name="last_name")
	private String lastName;

	@Column(name="last_password_change_ts")
	private Timestamp lastPasswordChangeTs;
	...
	public String getIsPasswordFirsttime() {
		return this.isPasswordFirsttime;
	}

	public void setIsPasswordFirsttime(String isPasswordFirsttime) {
		this.isPasswordFirsttime = isPasswordFirsttime;
	}
	...
	public Timestamp getLastPasswordChangeTs() {
		return this.lastPasswordChangeTs;
	}

	public void setLastPasswordChangeTs(Timestamp lastPasswordChangeTs) {
